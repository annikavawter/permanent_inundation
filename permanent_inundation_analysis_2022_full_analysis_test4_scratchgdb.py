    ...
    for region in regions:
        for projection in projections:
            for year in years:
                ...
                gdb_in = 'C:/Users/annik/Documents/UCS/Data/2022/permanent_inundation/scratch.gdb' .format(region)
                ...
                if region == 'east_coast':
                    ...
                    for area in areas:
                        ...
                        for raster_inund_file in raster_inund_files:
                            ...
                            outname_resample_path = str(gdb_in) + '/' + str(outname_resample)  
